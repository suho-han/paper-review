...
def build_vectordb_from_json(json_file: str, collection_name: str = "iclr_2025"):
    """
    ...
    collection = client.create_collection(
        ...
        metadata={"description": f"{collection_name} paper abstracts and reviews"}
    )
    ...
    print(f"\nVector DB 구축 완료!")
    if skipped_papers:
        print(f"Skipped {skipped_papers} papers without reviews")
...
def test_vectordb_query(collection_name: str = "iclr_2025", query: str = None):
    """
